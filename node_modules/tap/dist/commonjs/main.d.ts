...
declare const bailout: (message?: string) => void, comment: (...args: any[]) => void, end: () => TAP, fail: (...[msg, extra]: import("@tapjs/core").MessageExtra) => boolean, pass: (...[msg, extra]: import("@tapjs/core").MessageExtra) => boolean, plan: (n: number, comment?: string) => void, pragma: (set: {
    [k: string]: boolean;
}) => void, skip: {
    ...
    tapStream?: import("stream").Readable | import("minipass").Minipass<string | Buffer>;
}) => void, test: {
    (name: string, extra: import("@tapjs/test").TestOpts, cb: (t: import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins) => any): import("@tapjs/core").PromiseWithSubtest<import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins>;
    (name: string, cb: (t: import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins) => any): import("@tapjs/core").PromiseWithSubtest<import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins>;
    (extra: import("@tapjs/test").TestOpts, cb: (t: import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins) => any): import("@tapjs/core").PromiseWithSubtest<import("@tapjs/test").Test<import("@tapjs/test").BuiltPlugins, import("@tapjs/test").TestOpts> & import("@tapjs/test").BuiltPlugins>;
...
declare const spawn: {
    ...
    (cmd: string, options: import("@tapjs/spawn").SpawnOpts, name?: string): import("@tapjs/spawn").PromiseWithSpawn;
    (cmd: string, args: string | string[], name?: string): import("@tapjs/spawn").PromiseWithSpawn;
    (cmd: string, args: string | string[], options: import("@tapjs/spawn").SpawnOpts, name?: string): import("@tapjs/spawn").PromiseWithSpawn;
};
declare const stdin: {
...
declare const worker: {
    ...
    (filename: string, name?: string): import("@tapjs/worker").PromiseWithWorker;
    (filename: string, options: import("@tapjs/core").WorkerOpts, name?: string): import("@tapjs/worker").PromiseWithWorker;
};
declare const testdir: (content?: import("@tapjs/fixture").FixtureDirContent) => string, fixture: <T extends import("@tapjs/fixture").FixtureType>(type: T, content: import("@tapjs/fixture").FixtureContent<T>) => import("@tapjs/fixture").Fixture<T>;

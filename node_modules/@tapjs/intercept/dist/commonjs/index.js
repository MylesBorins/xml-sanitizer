...
exports.plugin = exports.Interceptor = void 0;
...
class Interceptor {
    ...
    intercept(obj, prop, desc, strictMode = true) {
        ...
        if (this.#t.t?.pluginLoaded(after_1.plugin)) {
            ...
            get() {
                ...
                try {
                    ...
                    resList.push({
                        receiver: this,
                        type: 'get',
                        at: (0, stack_1.at)(interceptor.get),
                        stack: (0, stack_1.captureString)(interceptor.get),
                        value,
                        threw,
                        success,
                    });
            ...
            set(value) {
                ...
                try {
                    ...
                    resList.push({
                        receiver: this,
                        type: 'set',
                        at: (0, stack_1.at)(interceptor.set),
                        stack: (0, stack_1.captureString)(interceptor.set),
                        value,
                        success,
                        threw,
                    });
    ...
    captureFn(original) {
        ...
        return Object.assign(function wrapped(...args) {
            const res = {
                receiver: this,
                args,
                at: (0, stack_1.at)(wrapped),
                stack: (0, stack_1.captureString)(wrapped),
            };
            try {
                const returned = res;

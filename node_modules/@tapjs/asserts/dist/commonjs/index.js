...
exports.plugin = exports.Assertions = void 0;
...
const normalize_throws_args_js_1 = require("./normalize-throws-args.js");
...
class Assertions {
    ...
    #onBeforeEnd() {
        for (const [emitted, emitter, event, handler, msg, extra] of this
            ...
            if (emitted) {
                ...
                if (emitter instanceof events_1.default) {
    ...
    ok(obj, ...[msg, extra]) {
        ...
        const me = (0, core_1.normalizeMessageExtra)('should be equal', args);
    ...
    equal(found, wanted, ...[msg, extra]) {
        ...
        if (objects(found, wanted)) {
            const { match, diff } = (0, tcompare_1.strict)(found, wanted, this.#opts);
            if (!match) {
    ...
    not(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should not be equal', args);
        if (found !== doNotWant) {
            return this.#t.pass(...me);
        }
        Object.assign(me[1], {
    ...
    type(obj, klass, ...[msg, extra]) {
        ...
        const name = typeof klass === 'function' ?
            ...
            : klass;
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)(`type is ${name}`, args);
    ...
    same(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should be equivalent', args);
        const { match, diff } = (0, tcompare_1.same)(found, wanted, this.#opts);
        if (match)
            return this.#t.pass(...me);
    ...
    notSame(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should not be equivalent', args);
        const { match } = (0, tcompare_1.same)(found, doNotWant, this.#opts);
        if (!match)
            return this.#t.pass(...me);
    ...
    strictSame(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should be equivalent strictly', args);
        const { match, diff } = (0, tcompare_1.strict)(found, wanted, this.#opts);
        if (match)
            return this.#t.pass(...me);
        Object.assign(me[1], { diff });
    ...
    strictNotSame(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should not be equivalent strictly', args);
        const { match } = (0, tcompare_1.strict)(found, doNotWant, this.#opts);
        if (!match)
            return this.#t.pass(...me);
        Object.assign(me[1], { found, doNotWant });
        return this.#t.fail(...me);
    ...
    has(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('all provided fields should be equivalent', args);
        const { match, diff } = (0, tcompare_1.has)(found, wanted, this.#opts);
        if (match)
            return this.#t.pass(...me);
        Object.assign(me[1], { diff });
        return this.#t.fail(...me);
    ...
    notHas(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('all provided fields should not be equivalent', args);
        const { match } = (0, tcompare_1.has)(found, doNotWant, this.#opts);
        if (!match)
            return this.#t.pass(...me);
        Object.assign(me[1], { found, doNotWant });
        return this.#t.fail(...me);
    ...
    hasStrict(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('all provided fields should be equivalent strictly', args);
        const { match, diff } = (0, tcompare_1.hasStrict)(found, wanted, this.#opts);
        if (match)
            return this.#t.pass(...me);
        Object.assign(me[1], { diff });
        return this.#t.fail(...me);
    ...
    notHasStrict(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('all provided fields should not be equivalent strictly', args);
        const { match } = (0, tcompare_1.hasStrict)(found, doNotWant, this.#opts);
        if (!match)
            return this.#t.pass(...me);
        Object.assign(me[1], { found, doNotWant });
        return this.#t.fail(...me);
    ...
    match(found, wanted, ...[msg, extra]) {
        ...
        const { match: ok, diff } = (0, tcompare_1.match)(found, wanted, this.#opts);
        if (ok)
            return this.#t.pass(...me);
        Object.assign(me[1], { diff });
        return this.#t.fail(...me);
    ...
    notMatch(found, doNotWant, ...[msg, extra]) {
        ...
        const { match: ok } = (0, tcompare_1.match)(found, doNotWant, this.#opts);
        if (!ok)
            return this.#t.pass(...me);
        Object.assign(me[1], { found, doNotWant });
        return this.#t.fail(...me);
    ...
    matchOnly(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should match pattern', args);
        const { match: ok, diff } = (0, tcompare_1.matchOnly)(found, wanted, this.#opts);
        if (ok)
            return this.#t.pass(...me);
        Object.assign(me[1], { diff });
        return this.#t.fail(...me);
    ...
    notMatchOnly(found, doNotWant, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should not match pattern', args);
        const { match: ok } = (0, tcompare_1.matchOnly)(found, doNotWant, this.#opts);
        if (!ok)
            return this.#t.pass(...me);
        Object.assign(me[1], { found, doNotWant });
        return this.#t.fail(...me);
    ...
    hasProp(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('specified property should be defined', args);
    ...
    hasOwnProp(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('specified property should be defined own property', args);
        Object.assign(me[1], { found, wanted });
        try {
    ...
    hasProps(found, wanted, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)('should have all specified properties', args);
        Object.assign(me[1], { found, wanted });
    ...
    throws(fn, ...[wanted, msg, extra]) {
        ...
        const [w, m, e] = (0, normalize_throws_args_js_1.normalizeThrowsArgs)(fn.name || 'expected to throw', args);
        try {
            fn();
    ...
    doesNotThrow(fn, ...[msg, extra]) {
        ...
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)(fn.name || 'expect to not throw', args);
        try {
            fn();
            return this.#t.pass(...me);
        }
    ...
    emits(emitter, event, ...[msg, extra]) {
        const args = [msg, extra];
        const me = (0, core_1.normalizeMessageExtra)(`expect ${event} to be emitted`, args);
...
const plugin = (t, opts = {}) => new Assertions(t, opts);

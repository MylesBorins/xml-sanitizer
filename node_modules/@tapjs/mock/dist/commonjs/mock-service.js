...
class MockService {
    ...
    async resolve({ url, parentURL }) {
        const resolvedURL = hasOwn(this.mocks, url) ? url
            : (0, is_relative_require_1.isRelativeRequire)(url) ? String(new URL(url, parentURL))
                : (0, path_1.isAbsolute)(url) ? String((0, url_1.pathToFileURL)(url))
                    : url;

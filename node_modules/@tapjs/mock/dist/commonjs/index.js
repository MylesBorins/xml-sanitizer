...
class TapMock {
    ...
    createMock(bases, overrides) {
        if (Array.isArray(overrides))
            return overrides;
        const mockedObject = Object.fromEntries(Object.entries(bases)
            .map(([k, v]) => {
            if (k in overrides) {
            ...
            .concat(Object.entries(overrides).filter(([k]) => !Object.hasOwnProperty.call(bases, k))));
    ...
    mock(module, mocks = {}) {
        ...
        return (0, mock_require_js_1.mockRequire)(module, mocks, m);
    }
    /**
    ...
    async mockImport(module, mocks = {}) {
        ...
        const service = await mock_service_js_1.MockService.create(module, mocks, mockImport);
    ...
    mockRequire(module, mocks = {}) {
        ...
        return (0, mock_require_js_1.mockRequire)(module, mocks, mr);
    }
    /**

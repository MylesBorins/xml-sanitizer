...
import { config as pluginConfig, defaultPlugins, testFileExtensions, } from '@tapjs/test';
import { lstat, readdir, readFile, writeFile } from 'fs/promises';
import { basename, dirname, relative, resolve } from 'path';
import { kIndent, parse as jsonParse, stringify as jsonStringify, } from 'polite-json';
...
const exists = async (f) => lstat(f).then(() => true, () => false);
/**
...
export class TapConfig {
    ...
    get pluginList() {
        ...
        const pluginSet = new Set(defaultPlugins);

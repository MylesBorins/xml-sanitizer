 ...
 */
exports.default = (0, jackspeak_1.jack)({
    envPrefix: 'TAP',
    ...
    .description(`Short options are parsed gnu-style, so for example \`-bCRterse\` would be
    ...
    .description(`Replay the results of the last test run, optionally specifying
    ...
    .description(`Open a REPL for interacting with the test suite. This can be used to
    ...
    .description(`Print the resolved values of the keys specified.
    ...
    .description(`Print the configuration from the config file, and from all environment
    ...
    .description(`Current effect configuration is dumped in YAML format, without
    any highlighting or sorting.`)
    .heading('tap config set <key=val> [<key=val> ...]', 4, {
    pre: true,
})
    .description(`Set the specified keys and values.
    ...
    .description(`Open the tap configuration in YAML format in your editor. Upon
    ...
    .description(`Output various debugging information, useful when posting issues
    ...
    .description(`If a \`TAP_RCFILE\` value is set in the process environment, then that
  ...
  `,
    ...
    .description(`Tap runs multiple test files in parallel. This generally
